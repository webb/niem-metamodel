...
![Use of the metamodel to support technologies](M_IMAGE_DIR()metamodel-tools.png "Models can be used many ways, to support many technologies.")
...
![The metamodel is a model that defines models for models](M_IMAGE_DIR()metamodel-workflow.png "The metamodel is a model that defines models for models.")
...
![The contents of a model](M_IMAGE_DIR()metamodel-core.png "The contents of a model")
